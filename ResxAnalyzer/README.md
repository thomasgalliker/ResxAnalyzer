...
| `PunctuationConsistencyCheck` | Localized values preserve terminal punctuation from the neutral value. | Checks punctuation such as `.`, `?`, `!`, `:`, `;`, `...`, and `…`. |
...
The recommended test usage is the fluent API with explicit checks:
