...
| `NewlineConsistencyCheck`      | ✅       | Localized values preserve leading and trailing newline characters from the neutral value.                                                                                                                                    |
| `NewlineStartEndCheck`         |         | Resource values do not start or end with newline characters. Applies to neutral and localized resources.                                                                                                                     |
...
| `WhitespaceConsistencyCheck`   | ✅       | Localized values preserve leading and trailing non-newline whitespace from the neutral value. Reports spaces and tabs at the edges.                                                                                          |
| `WhitespaceStartEndCheck`      |         | Resource values do not start or end with non-newline whitespace. Applies to neutral and localized resources.                                                                                                                 |
